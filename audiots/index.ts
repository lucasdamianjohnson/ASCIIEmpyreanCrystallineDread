import { AudioDate as AudioData } from "./Meta/AudioData.type";
...
const init = async()=>{
  ...
  const audioData : AudioData= await getData("/data/audio/audio-data.json");
 ...
 const listener =  async () => {
  if(audioManager.audioConnected)return;
