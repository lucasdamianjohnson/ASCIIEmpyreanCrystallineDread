...
class MenuSceneManager {
    constructor(DS) {
        ...
        this.DS.controlManager.addToKeyHook("up", () => {
        ...
        this.DS.controlManager.addToKeyHook("down", () => {
    ...
    setActiveScene(metaName, sceneId) {
        ...
        if (this.activeScene.entityLocations) {
            for (const entity of this.activeScene.entityLocations[this.activeScene.activeEntityMap]) {
                this.DS.entityManager.createNewEntity(entity.data.data ? entity.data.data : {}, entity.data.entityName, entity.data.type, entity.x, entity.y);
            }
        }
        return this;
    }
