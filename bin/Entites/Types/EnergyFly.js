...
class EnergyFly {
    ...
    _setUpKeyFrames() {
        this.keyFrames = [
            ...
            {
                text: "<<>>",
                styleObj: { fg: this.fgColor, bright: false },
                interval: 6,
            },
            {
                text: "<0>",
    ...
    _collisionCheck(going) {
        ...
        switch (going) {
            ...
            case "right":
                try {
                    data = DS.readWorldDataSection(this.y - 1, this.y + 1, this.x + 7, this.x + 7);
                }
                catch (error) {
                    console.log(going);
                    console.log(error);
