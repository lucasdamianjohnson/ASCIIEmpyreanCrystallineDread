...
export class RightBattleMenu implements EntityInterface {
  ...
  boxStyle: StyleObject = { bg: "Blue", fg: "Black", dim: true };
  style: StyleObject = { fg: "Blue" };
  activeStyle: StyleObject = { fg: "Black", bg: "Blue", dim: true };
  selectedStyle: StyleObject = { fg: "Black", bg: "Blue", bright: true };
